 ...
 * keeps a partial refresh down to one {@code clear} plus the new elements.</p>
 */
public interface LinkRenderer {
     ...
     * @param selector the group receiving the elements, sized like the canvas
     * @param from     centre of the prerequisite node, in canvas pixels
     * @param to       centre of the dependent node, in canvas pixels
     * @param state    what the link should look like
     */
    void render(UICommandBuilder builder, String selector,
